...
export default function MoveButtons({ disabled, onMove }: Props) {
  const btn = 'w-14 h-14 sm:w-12 sm:h-12 rounded-md bg-gray-900 text-white text-xl sm:text-lg flex items-center justify-center shadow-sm hover:bg-gray-800 active:scale-[0.98] transition disabled:opacity-50 disabled:hover:bg-gray-900'
  return (
    <div className="inline-grid grid-cols-3 gap-2 select-none" role="group" aria-label="Move controls">
      ...
      <div className="w-14 h-14 sm:w-12 sm:h-12 hidden md:flex items-center justify-center text-xs text-gray-400">WASD</div>
