...
function Navbar() {
  ...
  return (
    <div className="md:sticky md:top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-white/70 dark:supports-[backdrop-filter]:bg-gray-900/60 bg-white/95 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-800">
